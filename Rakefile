...
desc 'Generate documentation for the pagamento_certo_gateway extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'PagamentoCertoGatewayExtension'
...
desc 'Test the pagamento_certo_gateway extension.'
